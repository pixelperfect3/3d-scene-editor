...
protected:
	...
	/**
	 * Handles change requests (i.e. from the client).
	 * @param channel - Refer to the VRPN_WIIMOTE_CHANNEL_XXX defines (above).
	 * @param value - depends on channel/implementation, I suppose.
	 */
	void handle_change_request(vrpn_int32 channel, vrpn_float64 value);
private:
        // The WiiMote to use
